 ...
 * currently designed to extract the peak locations and color values for
 * each base at those locations.
 */
public class ABITrace implements NameProperty {
	...
	public static ABITrace parse(Path file) throws IOException {
		...
		try {
			...
			//SysUtils.err().println("dir:", dirName, tag, type, elementSize, numDirs, dataSize, dirOffset);
			...
			for (int i = 0; i < numDirs; ++i) {
				...
				//SysUtils.err().println("dir2:", i, dirName, tag, type, elementSize, numElements, dataSize, offset);
			}
