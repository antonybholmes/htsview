...
public abstract class SampleAssembly {
	...
	/**
	 * Should return the number of mapped reads for the sample. If it
	 * returns -1, it is assumed the number of reads are unknown so there
	 * will not be any normalization of the sample.
	 *
	 * @param sample the sample
	...
	/**
	 * Should return true if this file type supports tracking individual
	 * reads.
	 *
	 * @param sample the sample
