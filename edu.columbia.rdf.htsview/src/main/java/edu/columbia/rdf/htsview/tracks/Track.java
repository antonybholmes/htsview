...
public abstract class Track extends ChangeListeners
  ...
  /**
   * Should return the name of the track so users can see what they are looking
   * at.
   *
   * @return the name
   */
  ...
  /**
   * Set all the y properties at once using an axis limits model. Equivalent to
   * calling:
   * 
  ...
  /**
   * If set to true, applicable graphs will automatically determine a suitable y
