...
public class SampleFsPlotTrack extends SamplePlotTrack {
	 ...
	 */
	public SampleFsPlotTrack(Sample sample, 
	...
	/* (non-Javadoc)
	 * @see edu.columbia.rdf.htsview.tracks.sample.SamplePlotTrack#toXml(org.w3c.dom.Document)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.columbia.rdf.htsview.tracks.sample.SamplePlotTrack#toJson(org.abh.common.json.JsonBuilder)
	 */
	@Override
